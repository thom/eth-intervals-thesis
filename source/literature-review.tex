...
\item[\textbullet] Limits of work-stealing scheduling \cite{Vrba2009}
\item[\textbullet] Enabling scalability and performance in a large
...
\item[\textbullet] Checkfence: checking consistency of concurrent data
...
\item[\checkmark] Dynamic circular work-stealing deque
  \cite{Chase2005}
\item[\textbullet] A dynamic-sized nonblocking work stealing deque
  \cite{Hendler2006}
\item[\textbullet] A dynamic-sized nonblocking work stealing deque
  \cite{Hendler2006a}
\item[\textbullet] Non-blocking steal-half work queues
  \cite{Hendler2002}
\item[\textbullet] The design of a task parallel library
  \cite{Leijen2009}
...
\item[\textbullet] Solution of a problem in concurrent programming
  control \cite{Dijkstra1965}
\item[\textbullet] Lock-free dynamically resizable arrays
  \cite{Dechev2006}
\item[\textbullet] A methodology for implementing highly concurrent
  data objects \cite{Herlihy1993}
\item[\textbullet] IBM System/370 Principles of Operation
  \cite{IBM1974}
\item[\textbullet] Hazard pointers: safe memory reclamation for
