...
\begin{itemize}
\item[\texttimes] Phasers: a unified deadlock-free construct for
  collective and point-to-point synchronization \cite{Shirako2008}
\item[\texttimes] Hierarchical Phasers for Scalable Synchronization
  and Reductions in Dynamic Parallelism \cite{Shirako2010}
\item[\texttimes] Producing wrong data without doing anything
  obviously wrong! \cite{Mytkowicz2009}
\item[\texttimes] A Simple Task Load Balancing in Parallel Scheme for
