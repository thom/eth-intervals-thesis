...
\ref{lst:interval-class}). \lstinline|Interval| provides final fields
...
Listing \ref{lst:interval-graph} shows the code used to construct the
graph shown in Figure \ref{fig:interval-graph}.
...
\ref{lst:interval-graph-inline-end} create an inline interval by
...
Lines \ref{lst:interval-graph-new-start} --
