...
\begin{figure}[ht]
  \centering
  \subfigure[Intel Core2 Duo: 2 threads, 2 workers]{
    \includegraphics[width=0.47\linewidth]{queues-evaluation/marvin-deques}
    \label{fig:queues-evaluation-marvin-deques}
  }
  \subfigure[Intel Nehalem: 8 threads, 8 workers]{
    \includegraphics[width=0.47\linewidth]{queues-evaluation/mafushi-deques}
    \label{fig:queues-evaluation-mafushi-deques}
  }
...
\begin{figure}[ht]
  \centering
  \subfigure[Intel Core2 Duo: 2 threads, 2 workers]{
    \includegraphics[width=0.47\linewidth]{queues-evaluation/marvin-dynamic}
    \label{fig:queues-evaluation-marvin-dynamic}
  }
  \subfigure[Intel Nehalem: 8 threads, 8 workers]{
    \includegraphics[width=0.47\linewidth]{queues-evaluation/mafushi-dynamic}
    \label{fig:queues-evaluation-mafushi-dynamic}
  }
...
\subsection{Duplicating and Idempotent Work-Stealing Queues}
\label{sec:performance-alternative-duplicating}

\begin{figure}[ht]
  \centering
  \subfigure[Intel Core2 Duo: 2 threads, 2 workers]{
    \includegraphics[width=0.47\linewidth]{queues-evaluation/marvin-duplicating}
    \label{fig:queues-evaluation-marvin-duplicating}
  }
  \subfigure[Intel Nehalem: 8 threads, 8 workers]{
    \includegraphics[width=0.47\linewidth]{queues-evaluation/mafushi-duplicating}
    \label{fig:queues-evaluation-mafushi-duplicating}
  }
...
\begin{figure}[ht]
  \centering
  \subfigure[Intel Core2 Duo: 2 threads, 2 workers]{
    \includegraphics[width=0.47\linewidth]{queues-evaluation/marvin-idempotent}
    \label{fig:queues-evaluation-marvin-idempotent}
  }
  \subfigure[Intel Nehalem: 8 threads, 8 workers]{
    \includegraphics[width=0.47\linewidth]{queues-evaluation/mafushi-idempotent}
    \label{fig:queues-evaluation-mafushi-idempotent}
  }
...
\begin{figure}[ht]
  \centering
  \subfigure[Intel Core2 Duo: 2 threads, 2 workers]{
    \includegraphics[width=0.47\linewidth]{queues-evaluation/marvin-shared-queue}
    \label{fig:queues-evaluation-marvin-shared-queue}
  }
  \subfigure[Intel Nehalem: 8 threads, 8 workers]{
    \includegraphics[width=0.47\linewidth]{queues-evaluation/mafushi-shared-queue}
    \label{fig:queues-evaluation-mafushi-shared-queue}
  }
