...
% Because the array is indexed modulo its capacity, there is no need
% to update the \lstinline!top! or \lstinline!bottom! fields when
% moving the elements into a bigger array -- although the actual array
% indices where the elements are stored might change.
...
Specifically, the \lstinline!bottom! index indicates the next
