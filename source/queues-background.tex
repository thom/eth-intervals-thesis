...
\lstinline!put! method which puts \lstinline!workItem! onto the bottom
of the deque. The method automatically expands the array containing
the work items if it is full and fixes the indices in case they are
about to roll over (Lines
...
Listing \ref{lst:work-stealing-lazy-deque-take}
